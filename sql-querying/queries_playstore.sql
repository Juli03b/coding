...
SELECT ID, app_name FROM analytics WHERE last_updated = '2018-08-1';
...
SELECT MIN(last_updated) as oldest FROM analytics;
...
SELECT app_name, reviews, min_installs, (min_installs/reviews) as proportion FROM analytics WHERE min_installs > 100000 ORDER BY proportion DESC LIMIT 10;
